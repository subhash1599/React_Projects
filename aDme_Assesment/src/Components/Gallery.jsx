...
const Gallery = () => {
  ...
  return (
    <div className="container mx-auto px-4">
      ...
      <div className="mb-8">
        <img src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fGhlYWRlciUyMHBob3RvJTIwaGR8ZW58MHx8MHx8fDA%3D" alt="Header" className="w-full rounded-lg shadow-lg" />
      </div>
